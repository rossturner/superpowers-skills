...
> **For Claude:** Use `~/.claude/skills/executing-plans/SKILL.md` to implement this plan task-by-task.
...
After saving the plan, go on to execute it:

**"Plan complete and saved to `docs/plans/<filename>.md`.**

**Then go on to use Subagent-Driven Development:**
- Use skills/subagent-driven-development
